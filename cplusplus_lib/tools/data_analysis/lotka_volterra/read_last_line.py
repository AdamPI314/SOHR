...
if __name__ == '__main__':
    ...
    fn1 = os.path.join(file_dir, 'output', 'concentration_SOHR_M_3.csv')
    ...
    fn2 = os.path.join(file_dir, 'output', 'temperature_SOHR_M_3.csv')
    lr2 = get_last_row(fn2)[0]
    print(lr2)

    fn3 = os.path.join(file_dir, 'output', 'pressure_SOHR_M_3.csv')
    lr3 = get_last_row(fn3)[0]
    print(lr3)
