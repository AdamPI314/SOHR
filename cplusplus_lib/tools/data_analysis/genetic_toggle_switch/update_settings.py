...
def update_dlsode_settings(file_dir, time=None):
    ...
    if time is not None:
        ...
        time_n = rll.read_time(os.path.join(file_dir, 'output', 'time_SOHR_M_all.csv'))
...
def update_settings(file_dir, t_iter_N=None, dt=None):
    ...
    if tin == 0:
        ...
        concentration = rll.read_concentration(
                os.path.join(file_dir, 'output', 'concentration_SOHR_M_all.csv'))
        curr_settings['chem_init']['species_index_concentration'] = concentration

        temperature = rll.read_temperature(
                os.path.join(file_dir, 'output', 'temperature_SOHR_M_all.csv'))
        curr_settings['chem_init']['init_temperature'] = temperature

        pressure = rll.read_pressure(
                os.path.join(file_dir, 'output', 'pressure_SOHR_M_all.csv'))
        curr_settings['chem_init']['pressure_atm'] = pressure

    # curr_settings['job']['job_type'] = "ODE_solver_path_integral_parallel_cv_v6"
    # curr_settings['job']['job_type'] = "ODE_solver_path_integral_parallel_cv_v7"
    # curr_settings['job']['job_type'] = "ODE_solver_path_integral_parallel_cv_v8"
    # curr_settings['job']['job_type'] = "ODE_solver_path_integral_parallel_cv_v9"
    # curr_settings['job']['job_type'] = "ODE_solver_path_integral_parallel_cv_v11"
    # curr_settings['job']['job_type'] = "test_ODE_solver_path_integral_parallel_cv"
    # curr_settings['job']['job_type'] = "ODE_solver_path_integral_parallel_cv_ct_v1"
    # curr_settings['job']['job_type'] = "ODE_solver_path_integral_parallel_cv_ct_v2"
    # curr_settings['job']['job_type'] = "ODE_solver_path_integral_parallel_cv_ct_v3"
	curr_settings['job']['job_type'] = "ODE_solver_path_integral_parallel_s_ct_np_cc1_v1"
    # curr_settings['job']['job_type'] = "ODE_solver_path_integral_parallel_s_ct_np_cc1_v2"
    # curr_settings['job']['job_type'] = "ODE_solver_path_integral_parallel_s_ct_np_cc1_v3"
    # curr_settings['job']['job_type'] = "ODE_solver_path_integral_parallel_s_ct_np_cc1_v4"
