...
C     KDIM = maximum number of species in a problem;             (150)
...
C     IDIM = maximum number of reactions in a mechanism;         (1500)
...
C
      PARAMETER (MDIM=50,KDIM=1000,MKDIM=MDIM*KDIM,IDIM=60000,LSYM=16,
