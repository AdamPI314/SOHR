...
def get_fast_rxn_trapped_spe(atom_followed="C"):
    """
    ...
    fast_transitions = [
        ...
        {
            "formula1": "O2+npropyl=>npropyloo",
            "formula2": "npropyloo=>O2+npropyl",
            "rxn": [1068, 1069],
            "spe": {
                "H": [60, 78],
                "O": [9, 78],
        ...
        {
            "formula1": "O2+ipropyl=>ipropyloo",
            "formula2": "ipropyloo=>O2+ipropyl",
            "rxn": [1096, 1097],
            "spe": {
                "H": [61, 80],
                "O": [9, 80],
        ...
        {
            "formula1": "O2+QOOH_1=>well_1",
            "formula2": "well_1=>O2+QOOH_1",
            "rxn": [1116, 1117],
            "spe": {
                "H": [87, 90],
                "O": [9, 90],
    ...
    for _, r_s in enumerate(fast_transitions):
        ...
        trapped_species_list.append(
            tuple([str(r_s['spe'][atom_followed][0]), int(r_s['spe'][atom_followed][1])]))
